  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      type: 'bot',
      content: 'Hello! I\'m your AI Health Assistant. I\'m here to help you with questions about Thalassemia, diet, care, and support. How can I assist you today?',
      timestamp: new Date()
    }
  ]);
      ...
      <div className="container">
        ...
        <div className="chatbot-header">
          <div className="header-content">
            <h1 className="gradient-text">AI Health Assistant</h1>
